...
const Card = ({ userInfo, index }: { userInfo: Userinfo, index: number }) => {
    ...
    return (
        <Link href={`/bot/?no=${index}`}>
            <div
                className={`bg-cover bg-center rounded-4xl  w-[190px] h-[260px] sm:w-[300px] md:w-[calc((100% - 160px - 80px) / 5)] sm:h-[400px] grayscale-50 relative cursor-pointer`}
                ...
                <div className="absolute bottom-0 w-full align-middle text-center p-3">
                    <div className="flex">
                        ...
                        <div className="flex flex-col pl-1">
                            <div className="flex text-white font-bold text-[12px] sm:text-[18px]">
                                <div className="">Name:</div>
                                <div className="">{name}</div>
                            </div>
                            <div className="flex text-white font-bold text-[12px] sm:text-[16px]">
                                <div className="">{age} YRS - {nationality.toUpperCase()}</div>
                            </div>
                        </div>
                    </div>
                    <div className="flex pt-2">
                        <div className="text-left text-white text-[12px] sm:text-[16px]">{description.substring(0, 100)} ...</div>
                    </div>
                </div>
